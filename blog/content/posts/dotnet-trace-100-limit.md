...
"traceEvents": [
    ...
    {"name": "Cmf.Foundation.Services.HostService.Program.Main(class System.String[])",
        "cat": "sampleEvent", "ph": "B", "ts": 580.102, "pid": 0, "tid": 19, "sf": 4},
    ...
```

Large trace files can easily have tens of thousands of these events! For more information on this trace file format, please go check [this document](https://docs.google.com/document/d/1CvAClvFfyA5R-PhYUmn5OOQtYMH4h6I0nSsKchNAySU/preview?tab=t.0).
