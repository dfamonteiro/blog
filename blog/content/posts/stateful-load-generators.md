...
[^1]: It's quite hard to boot your computer when your computer is in orbit.
...
While open-source projects such as [Linux](https://www.linux.org/) and [SQLite](https://sqlite.org/) highlight a wide variety of software testing methodologies, the reality is that most enterprise software projects typically employ only a subset of the most popular types of software testing. This leads to certain side effects: functional tests such as unit tests, integration tests and end-to-end tests are very well understood across the industry and have plenty of tooling support. On the other hand, less popular types of testing (fuzzing, stress tests, etc) are less well supported and require you to go off the trodden path and invest a lot of effort to adapt them to your project's needs.[^2]
...
Implementing less popular types of tests might give you a couple of headaches, but at least it's going to be far more intellectually engaging than writing run-of-the-mill unit tests. In this blog I hope to give new perspectives on designing load generators that can then be used for performance testing, load testing and stress testing.

<!-- TODO: not really happy with this intro, maybe it could be a little shorter and to the point -->
