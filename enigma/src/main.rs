...
fn plugboard_test() {
    let candidate_keys = [
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (1, 1, 1), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (12, 17, 12), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (25, 7, 16), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (4, 23, 2), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (1, 1, 1), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (25, 7, 21), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (19, 25, 9), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (1, 17, 16), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (1, 1, 1), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (15, 2, 17), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (1, 1, 1), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (2, 23, 16), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (15, 17, 23), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (4, 14, 21), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (24, 20, 1), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (2, 25, 16), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (5, 1, 13), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (24, 23, 7), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (9, 23, 7), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (14, 11, 20), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (2, 17, 8), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (2, 7, 3), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (10, 12, 11), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (24, 21, 15), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (17, 26, 23), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (3, 7, 13), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (18, 22, 15), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (23, 5, 17), ring_settings: (11, 4, 3), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (13, 21, 18), ring_settings: (14, 24, 13), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (6, 26, 6), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (20, 26, 17), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (11, 24, 19), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (21, 14, 20), ring_settings: (19, 13, 20), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (13, 7, 17), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (17, 10, 3), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (26, 8, 22), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (26, 25, 1), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (6, 14, 17), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (10, 14, 15), ring_settings: (16, 17, 19), plugboard: String::new() },
        EnigmaEncryptionKey { reflector: 'B', rotors: (1, 2, 3), ring_positions: (13, 7, 18), ring_settings: (16, 17, 19), plugboard: String::new() },
    ];
...
fn test_permutations(key: EnigmaEncryptionKey, cyphertext : &str, language_model: &HashMap<String, f64>, number_of_candidates : usize) -> Vec<(f64, EnigmaEncryptionKey)> {
    let mut res: Vec<(f64, Vec<(char, char)>, EnigmaEncryptionKey)> = vec![(english_score(&decrypt(&key, cyphertext), language_model), Vec::new(), key.clone())];
    ...
    loop {
        ...
        for i in 0..alphabet.len() {
            for j in (i+1)..alphabet.len() {
                ...
                let test_score = english_score(&decrypt(&new_key, cyphertext), language_model);

                if test_score > score {
                    res.push((test_score, plugboard.clone(), new_key));
                }
    ...
    res.iter().map(|(score, _plugboard, key)| (score.clone(), key.clone())).collect::<Vec<(f64, EnigmaEncryptionKey)>>()
}
