...
tags = ["Rust", "compilers", "Brainfuck", "intermediate representation", "programming"]
categories = []
externalLink = ""
series = []
+++
...
## Final remarks and a Mandelbrot set

Sometimes, the most useless projects are the ones that are the most fun to work on. Well, I certainly enjoyed working on this compiler and I hope you enjoyed reading about it. Finally, you can find [here](https://github.com/dfamonteiro/blog/blob/main/brainfuck/src/main.rs "Github page with the source code") the source code used for this blog post. I'll leave you with an ASCII representation of the Mandelbrot set, generated by the compiler.

![ASCII representation of the Mandelbrot set](/images/mandelbrot.png)
